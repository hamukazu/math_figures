...
\begin{tikzpicture}
  ...
  \fill(\a:2)circle[radius=2pt]node[right,font=\small]{$(\cos\theta,\sin\theta)$};
  \fill(180-\a:2)circle[radius=2pt]node[left,font=\small]{$(-\cos\theta,\sin\theta)$};
  \fill(-\a:2)circle[radius=2pt]node[right,font=\small]{$(\cos\theta,-\sin\theta)$};
\end{tikzpicture}
\end{figure}
...
\begin{tikzpicture}
  ...
  {$\theta$};
  \fill(\a:4)circle[radius=2pt]node[right,font=\small]{$(\cos\theta,\sin\theta)$};
  \fill(90-\a:4)circle[radius=2pt]node[above right,font=\small]{$(\sin\theta,\cos\theta)$};
\end{tikzpicture}
\end{figure}
